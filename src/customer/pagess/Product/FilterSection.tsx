...
const FilterSection = () => {
  ...
  return (
    <div className="-z-50 space-y-5 bg-white">
      <div className="flex items-center justify-between h-[40px] px-9 border-r">
        ...
        <section>
          <FormControl>
            <FormLabel
              ...
              className="text-2xl font-semibold"
              id="discount" // Corrected from "brand" to "discount"
            >
              Discount
            </FormLabel>
            <RadioGroup
              name="discount"
              onChange={updateFilterParams}
              aria-labelledby="discount" // Corrected to match id
              defaultValue=""
            >
              {discount.map((item) => (
                <FormControlLabel
