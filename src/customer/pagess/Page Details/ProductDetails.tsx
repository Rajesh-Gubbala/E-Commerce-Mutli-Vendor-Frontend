  ...
  return (
    <div className="px-5 lg:px-20 pt-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <section>
          <h1 className="font-bold text-lg text-green-700">{product.product?.seller?.businessDetails.businessName}</h1>
          <p className="text-gray-500 font-semibold">{product.product?.title}</p>
          <div className="flex justify-between items-center py-2 border w-[180px] px-3  mt-4">
          ...
          <div>
            <div className="price flex items-center gap-3 mt-5 text-2xl">
              ...
              <span className="text-green-700 font-semibold">{product.product?.discountPercent}%</span>
            </div>
            <p className="text-sm">
