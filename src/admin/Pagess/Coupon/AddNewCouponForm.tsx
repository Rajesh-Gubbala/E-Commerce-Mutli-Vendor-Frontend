...
//   return (
//     <div>
//       <h1 className="text-2xl font-bold text-green-700 pb-5 text-center">Create New Coupon</h1>
...
import { AdapterDayjs } from "@mui/x-date-pickers/AdapterDayjs";
import { DatePicker, LocalizationProvider } from "@mui/x-date-pickers";
import { Box, Button, Grid, TextField } from "@mui/material"; // Keep it as Grid
...
const AddNewCouponForm = () => {
  ...
  return (
    <div>
      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        <Box component={"form"} onSubmit={formik.handleSubmit} sx={{ mt: 3 }}>
          {/* In MUI v6, container is still used, but children use 'size' */}
